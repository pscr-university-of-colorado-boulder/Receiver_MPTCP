...
static struct ctl_table ipv4_table[] = {
	...
	{
                .procname       = "fast_mptcp_plus",
                .data           = &sysctl_fast_mptcp_plus,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = proc_dointvec
        },
	{
                .procname       = "fast_mptcp_plus_c",
                .data           = &sysctl_fast_mptcp_plus_c,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = proc_dointvec
        },
	{
                .procname       = "fast_mptcp_plus_alpha",
                .data           = &sysctl_fast_mptcp_plus_alpha,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = proc_dointvec
        },
	{
                .procname       = "fast_mptcp_plus_rtt_wnd",
                .data           = &sysctl_fast_mptcp_plus_rtt_wnd,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = proc_dointvec
        },
	{
                .procname       = "fast_mptcp_plus_rtt_thr",
                .data           = &sysctl_fast_mptcp_plus_rtt_thr,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = proc_dointvec
        },
	{
                .procname       = "fast_mptcp_plus_rsv1",
                .data           = &sysctl_fast_mptcp_plus_rsv1,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = proc_dointvec
        },
	{
                .procname       = "fast_mptcp_plus_rsv2",
                .data           = &sysctl_fast_mptcp_plus_rsv2,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = proc_dointvec
        },
	{
                .procname       = "fast_mptcp_plus_rsv3",
                .data           = &sysctl_fast_mptcp_plus_rsv3,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = proc_dointvec
        },
